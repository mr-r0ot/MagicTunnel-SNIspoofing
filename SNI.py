...
if __name__ == "__main__":
    ...
    pr(f"""
[bold green]          SNI Spoofing started successfully! XD [/bold green]
[bold red]
   FAKE SNI Address: {FAKE_SNI.decode()}
    Addres: {LISTEN_HOST}
    Port  : [bold green]{LISTEN_PORT}[/bold green]
[/bold red][bold yellow]
1- open v2rayng and click on Edit in the cloudflare woker config
2- Change the Address to 127.0.0.1 and Change Port to {LISTEN_PORT}
3- Click on SAVE and connecting to config


Supporting from creator SNI Spoofing part:
